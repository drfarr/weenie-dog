...
const Schema: z.ZodType<Prisma.ProjectViewUncheckedUpdateManyWithoutProjectNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const ProjectViewUncheckedUpdateManyWithoutProjectNestedInputObjectSchema =
  Schema;
