...
const Schema: z.ZodType<Prisma.ProjectViewUncheckedCreateWithoutProjectInput> =
  z
    .object({
...
export const ProjectViewUncheckedCreateWithoutProjectInputObjectSchema = Schema;
