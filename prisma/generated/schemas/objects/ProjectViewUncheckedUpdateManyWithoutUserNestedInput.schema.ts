...
const Schema: z.ZodType<Prisma.ProjectViewUncheckedUpdateManyWithoutUserNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const ProjectViewUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
