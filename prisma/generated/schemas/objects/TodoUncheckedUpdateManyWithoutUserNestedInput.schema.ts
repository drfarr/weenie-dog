...
const Schema: z.ZodType<Prisma.TodoUncheckedUpdateManyWithoutUserNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const TodoUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
