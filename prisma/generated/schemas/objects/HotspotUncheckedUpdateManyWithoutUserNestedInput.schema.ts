...
const Schema: z.ZodType<Prisma.HotspotUncheckedUpdateManyWithoutUserNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const HotspotUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
