...
const Schema: z.ZodType<Prisma.HotspotUncheckedCreateNestedManyWithoutUserInput> =
  z.union([
    z
      .object({
        create: z
...
export const HotspotUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
